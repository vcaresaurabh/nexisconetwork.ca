...
function mail_template(array $data): string {
    ...
    if (!empty($data['cta_url']) && !empty($data['cta_text'])) {
        ...
        $cta  = "<div style='text-align:center;margin:32px 0'>
                   <a href='{$url}' style='display:inline-block;padding:14px 32px;background:linear-gradient(135deg,#06B6D4,#6366F1);color:#070A0F;text-decoration:none;border-radius:8px;font-weight:600;font-size:15px'>{$text}</a>
                 </div>";
    }
...
<body style="margin:0;padding:0;background:#070A0F;font-family:'Inter',sans-serif;color:#F8FAFC">
<!-- Preheader (hidden) -->
<div style="display:none;max-height:0;overflow:hidden;mso-hide:all">{$preheader}</div>

<table width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#070A0F;padding:40px 16px">
<tr><td align="center">
  <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;background:#0C1017;border-radius:12px;border:1px solid rgba(255,255,255,0.06);overflow:hidden">

    <!-- Header -->
    <tr>
      <td style="background:linear-gradient(135deg,rgba(6,182,212,0.15),rgba(99,102,241,0.1));padding:32px 40px;border-bottom:1px solid rgba(255,255,255,0.06)">
            ...
            <td>
              <div style="display:inline-flex;align-items:center;gap:10px">
                <div style="width:36px;height:36px;background:rgba(6,182,212,0.1);border:1px solid rgba(6,182,212,0.3);border-radius:8px;display:flex;align-items:center;justify-content:center">
                  <span style="color:#06B6D4;font-weight:700;font-size:16px">N</span>
                </div>
                <span style="font-size:18px;font-weight:700;color:#F8FAFC">Nexisco <span style="color:#06B6D4">Network</span></span>
              </div>
            </td>
          </tr>
        </table>
    ...
    <tr>
      <td style="padding:40px">
        <p style="font-size:16px;color:#94A3B8;margin:0 0 20px 0">{$greeting}</p>
        <div style="font-size:15px;line-height:1.7;color:#F8FAFC">{$body}</div>
        {$cta}
      </td>
    </tr>
    ...
    <!-- Footer -->
    <tr>
      <td style="padding:24px 40px;border-top:1px solid rgba(255,255,255,0.06);background:rgba(7,10,15,0.5)">
        <p style="font-size:12px;color:#64748B;margin:0;line-height:1.6">
          ...
          <strong style="color:#94A3B8">Nexisco Network Inc.</strong><br>
          1404, 49A Street NW, Edmonton, Alberta T6L 6H6, Canada<br>
          Phone: +1 (825) 771-7727 · Email: support@nexisconetwork.ca<br><br>
          <a href="https://nexisconetwork.ca/opt-in-opt-out" style="color:#06B6D4;text-decoration:none">Unsubscribe</a> ·
          <a href="https://nexisconetwork.ca/privacy" style="color:#06B6D4;text-decoration:none">Privacy Policy</a> ·
          <a href="https://nexisconetwork.ca/terms" style="color:#06B6D4;text-decoration:none">Terms</a><br><br>
